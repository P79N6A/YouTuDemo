package com.qcloud.qcloudfr_android_sdk.sign;

import java.util.Random;

public class QcloudFrSign {

	/**
    app_sign    时效性签名
    @param  appId       http://www.qcloud.com/上申请的业务ID
    @param  secret_id   http://www.qcloud.com/上申请的密钥id
    @param  secret_key  http://www.qcloud.com/上申请的密钥key
